    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                <a href="{{ route('budget-plans.create', ['travel_plan_id' => $travel_plan_id]) }}"
                    class="btn btn-primary mb-3">Add Budget Item</a>
                <div class="card">
                                ...
                                @else
                                    @foreach ($budgetPlans as $budget)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('budget-plans.edit', $budget->id) }}"
                                                    class="btn btn-sm btn-primary">Edit</a>
                                                <form action="{{ route('budget-plans.destroy', $budget->id) }}"
